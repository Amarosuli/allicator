<script lang="ts">
	...
	import DataTableImage from '$lib/components/costum/data-table-image.svelte';
	...
	import { getFileUrl } from '$lib/pocketbaseClient';
	...
	const { nextPage, prevPage, getState } = createPageFile().init('customers');
	...
	const hideableCols = ['name', 'description', 'logo', 'code_IATA', 'code_ICAO'];
</script>
...
<div class="relative mx-auto h-max w-full border p-4">
	...
	<div class="flex w-full items-center justify-between">
		<p class="w-full font-extrabold lg:text-xl">Customers</p>
		{#if user}
